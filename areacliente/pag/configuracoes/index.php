...
<form method="post">
        ...
        <div class="sepCol2" id="chk" style="width:970px">
        		<?php 
						//$Checks = array(); 
				...
				?>
                <br />
                <input type="checkbox" name="Checks[]" id="Checks1" value="1" <?php echo ((!empty($Checks)) && (in_array('1',$Checks))) ? "checked" : "";?>  /> Enviar e-mail sobre O.S. que precisam ser confirmadas<br />
                <input type="checkbox" name="Checks[]" id="Checks2" value="2" <?php echo ((!empty($Checks)) && (in_array('2',$Checks))) ? "checked" : "";?>  /> Enviar e-mail sobre Chamados com status "Aguardando Cliente"<br />
                <input type="checkbox" name="Checks[]" id="Checks3" value="3" <?php echo ((!empty($Checks)) && (in_array('3',$Checks))) ? "checked" : "";?>  /> Enviar e-mail para cliente sobre O.S., chamados, comentários, inclusão de materiais/serviços, etc<br />
                <input type="checkbox" name="Checks[]" id="Checks4" value="4" <?php echo ((!empty($Checks)) && (in_array('4',$Checks))) ? "checked" : "";?>  /> Enviar e-mail para usuário de clientes sobre O.S., chamados, comentários, inclusão de materiais/serviços, etc<br />
        		<input type="checkbox" name="Checks[]" id="Checks5" value="5" <?php echo ((!empty($Checks)) && (in_array('5',$Checks))) ? "checked" : "";?>  /> Enviar e-mail para o endereço cadastrado nas configurações do sistema sobre O.S., chamados, comentários, inclusão de materiais/serviços, etc<br />
        		<input type="checkbox" name="Checks[]" id="Checks6" value="6" <?php echo ((!empty($Checks)) && (in_array('6',$Checks))) ? "checked" : "";?>  /> Enviar e-mail para o usuário do sistema (Usuario Cliente/Técnico/Administrador logado) sobre O.S., chamados, comentários, inclusão de materiais/serviços, etc<br />
                <input type="checkbox" name="Checks[]" id="Checks8" value="8" <?php echo ((!empty($Checks)) && (in_array('8',$Checks))) ? "checked" : "";?>  /> Enviar e-mail para todos os usuários do sistema (Técnico/Administrador) sobre O.S., chamados, comentários, inclusão de materiais/serviços, etc<br />
                <input type="checkbox" name="Checks[]" id="Checks7" value="7" <?php echo ((!empty($Checks)) && (in_array('7',$Checks))) ? "checked" : "";?>  /> Ativar Avaliação de OS<br />
        </div>
