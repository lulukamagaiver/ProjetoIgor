...
if($VerMais == 0) :
		...
		$tt = new tabClientes;
		$tt->SqlWhere = $B->Where.(((!empty($B->Where)) && ($UsT->Clientes() != '')) ? " AND ".$UsT->Clientes() : $UsT->Clientes());
...
<div id="Imprimir"> <!-- Imprimir somente a lista de equipamentos -->
<?php echo (!empty($_POST['Nome'])) ? $_POST['Nome'] : (!empty($Cl->Nome)) ? $Cl->Nome : "";;?>
<?php
		include_once('lib/tabs/tabequipamento.php');
...
<div class="sepCont"></div>,
<div id="btImprimir" class="btnAct" onClick="Imprimir()"><img src="<?php echo $URL->siteURL;?>imgs/icones/print.png" /> Imprimir</div>
...
thead tr{	
background-color:#666;	color:#FFF;	font-weight:bold;	font-style:italic;}
tbody tr{	
...
base64=r;	
Img.attr('src',base64);}function Imprimir(){	
get64($('#Logo'));	$('#Imprimir').print();	return false;	
}
