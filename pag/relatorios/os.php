		...
		if((!empty($_POST['Envia'])) || (!empty($_POST['FechaOS']))|| (!empty($_POST['Envia_x']))){	
				...
				<div class="fundoTabela">
						<div class="topoTabela">
								...
								<div style=" <?php echo $a[5];?>">Fechar</div>
						</div>                
						...
						<div class="linhasTabela">
								...
								if($Mt->NumRows > 0){
										...
										echo "R$ ".number_format($Mt->MAX($Os->ID),2,',','');
								}else echo "NÃO";
								?></div>
								<div style=" <?php echo $a[5];?>">
                                <input type="checkbox" name="OS[]" class="chk" <?php echo ($Os->StatusOS == 2) ? "checked disabled" : "";?> value="<?php echo $Os->ID;?>" />
								</div>
						</div>
						<?php $Os->Next(); }?>
                ...
                <?php if($S->Pr(25)) :?><div class="btnAct" onclick="return $('input[name=FechaOS]').click();"><img src="<?php echo $URL->siteURL;?>imgs/icones/locked.png" /> Fechar Selecionadas</div><?php else :?><div class="btnAct" onclick="AcNegado();"><img src="<?php echo $URL->siteURL;?>imgs/icones/locked.png" /> Fechar Selecionadas</div><?php endif;?>
                ...
                <div class="sepCol3">
                        ...
                        Valor Total: R$ <strong><?php echo number_format($Os->TG['TValorMat'],2,',','');?></strong>
                </div>
                <?php endif;?>
